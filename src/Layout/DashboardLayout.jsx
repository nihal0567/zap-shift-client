    ...
    <div className="drawer lg:drawer-open max-w-7xl mx-auto">
      ...
      <div className="drawer-content">
        ...
        <nav className="navbar w-full bg-base-300">
          ...
          <div className="px-4">zap Shift Controller</div>
        </nav>
        {/* Page content here */}
        <Outlet></Outlet>
      ...
      <div className="drawer-side is-drawer-close:overflow-visible">
        ...
        <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
          ...
          <ul className="menu w-full grow">
            ...
            <li>
              <Link to='/dashboard/my-parcels' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="My Parcel">
                {/* Home icon */}
                <AiFillProduct />
            ...
            {/* rider only links */}
            {
              role=== 'rider' && <>
              <li>
                  <Link to='/dashboard/assigned-deliveries' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Assign Deliveries">
                    {/* Home icon */}
                    <FaTasks />
